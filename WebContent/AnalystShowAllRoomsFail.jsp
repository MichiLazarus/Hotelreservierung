...
<%
	...
	for(int i = 0; i < rlist.size(); i++){
		...
		out.println("<td name=\"offeredprice\">" + room.getPriceOffer() + " &euro;" + "</td>");
		else
		out.println("<td name=\"offeredprice\">" + "-" + "</td>");
		...
		out.println("<td>" +"<input type=\"text\" name=\"priceoffer\">" + "<input type=\"submit\" name=\"submit\" value=\"MakePriceOffer\" class=\"button tiny\">" + "</td>");
...
alert("Price offer failed. Please enter valid data!");
</script>
</body>
